...
# Unit tests for MyNJ::MynjAuth
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MynjAuth' do
  before do
    # run before each test
    @instance = MyNJ::MynjAuth.new
  end
  ...
  describe 'test an instance of MynjAuth' do
    it 'should create an instance of MynjAuth' do
      expect(@instance).to be_instance_of(MyNJ::MynjAuth)
    end
  end
