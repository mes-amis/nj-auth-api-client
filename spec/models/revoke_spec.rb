...
# Unit tests for MyNJ::Revoke
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Revoke' do
  before do
    # run before each test
    @instance = MyNJ::Revoke.new
  end
  ...
  describe 'test an instance of Revoke' do
    it 'should create an instance of Revoke' do
      expect(@instance).to be_instance_of(MyNJ::Revoke)
    end
  end
